    ...
    <div class="anav-list">
      ...
      <div class="adminname">
        ...
        <div class="under-admin-info">
          ...
          <div class="details-user" @click="UpdatePassword">
            Cập nhật mật khẩu
          </div>
      ...
      <router-link to="/admin/comment" style="text-decoration: none">
        <div
          class="anav-item"
          :class="{ 'item-active': checkActive('/admin/dashload') }"
        >
          <div
            class="anav__text"
            :class="{ 'text-active': checkActive('/admin/dashload') }"
          >
            Thống kê
          </div>
        </div>
      ...
      <div
        ...
        :class="{ 'item-active': checkActive('/admin/system') }"
      >
        <div
          class="anav__text"
          :class="{ 'text-active': checkActive('/admin/system') }"
        >
          Hệ thống
        </div>
      ...
      <router-link to="/admin/comment" style="text-decoration: none">
        <div
          class="anav-item"
          :class="{ 'item-active': checkActive('/admin/category') }"
        >
          <div
            class="anav__text"
            :class="{ 'text-active': checkActive('/admin/category') }"
          >
            Danh mục
          </div>
          <i style="color: black" class="fa-solid fa-chevron-down"></i>
      ...
      <router-link to="/admin/comment" style="text-decoration: none">
        <div
          class="anav-item"
          :class="{ 'item-active': checkActive('/admin/manage') }"
        >
          <div
            class="anav__text"
            :class="{ 'text-active': checkActive('/admin/manage') }"
          >
            Quản lý khám
          </div>
          <i style="color: black" class="fa-solid fa-chevron-down"></i>
...
export default {
  ...
  created() {
    ...
    setTimeout(() => {
      axios.get(ApiUser.getUserById(adminID)).then((res) => {
